...
import com.argentumjk.client.objects.User;
import com.argentumjk.client.utils.StrUtils;


import static com.argentumjk.client.containers.FontTypes.FontTypeName.*;
import static com.argentumjk.client.utils.StrUtils.*;
import static com.argentumjk.client.utils.StrUtils.TipoDato.*;
    ...
    public void parse(String texto) {
        ...
        switch (cmd) {
            ...
            default:
                ...
                if (Game.getInstance().getGameData().getChars().getChar(getU().getIndexInServer()).getPriv() > 0) {
                    switch (cmd) {
                        case "/GO":
                            cmdGo(params);
                            break;
