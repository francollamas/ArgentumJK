...
public class GnConnection implements Connection {
    ...
    //public static final String IP = "186.13.38.217";
    ...
    public boolean connect() {
        try {
            ...
            Dialogs.showOKDialog(Game.getInstance().getBundle().get("error"), "No se pudo establecer la conexión con el servidor.");
            socket = null;
            return false;
        }
        return false;
