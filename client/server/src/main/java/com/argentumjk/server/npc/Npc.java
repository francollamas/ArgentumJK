 ...
 *******************************************************************************/
package com.argentumjk.server.npc;

import static com.argentumjk.server.npc.NpcFlags.FLAG_AFECTA_PARALISIS;
import static com.argentumjk.server.npc.NpcFlags.FLAG_AGUA_VALIDA;
import static com.argentumjk.server.npc.NpcFlags.FLAG_ATACABLE;
import static com.argentumjk.server.npc.NpcFlags.FLAG_BACKUP;
import static com.argentumjk.server.npc.NpcFlags.FLAG_BENDICION;
import static com.argentumjk.server.npc.NpcFlags.FLAG_COMERCIA;
import static com.argentumjk.server.npc.NpcFlags.FLAG_ENVENENA;
import static com.argentumjk.server.npc.NpcFlags.FLAG_FACCION;
import static com.argentumjk.server.npc.NpcFlags.FLAG_FOLLOW;
import static com.argentumjk.server.npc.NpcFlags.FLAG_GOLPE_EXACTO;
import static com.argentumjk.server.npc.NpcFlags.FLAG_HOSTIL;
import static com.argentumjk.server.npc.NpcFlags.FLAG_INMOVILIZADO;
import static com.argentumjk.server.npc.NpcFlags.FLAG_INVISIBLE;
import static com.argentumjk.server.npc.NpcFlags.FLAG_INV_RESPAWN;
import static com.argentumjk.server.npc.NpcFlags.FLAG_LANZA_SPELLS;
import static com.argentumjk.server.npc.NpcFlags.FLAG_MALDICION;
import static com.argentumjk.server.npc.NpcFlags.FLAG_NPC_ACTIVE;
import static com.argentumjk.server.npc.NpcFlags.FLAG_OLD_HOSTILE;
import static com.argentumjk.server.npc.NpcFlags.FLAG_PARALIZADO;
import static com.argentumjk.server.npc.NpcFlags.FLAG_PUEDE_ATACAR;
import static com.argentumjk.server.npc.NpcFlags.FLAG_RESPAWN;
import static com.argentumjk.server.npc.NpcFlags.FLAG_RESPAWN_ORIG_POS;
import static com.argentumjk.server.npc.NpcFlags.FLAG_TIERRA_INVALIDA;
...
import com.argentumjk.server.inventory.Inventory;
...
End Enum
    ...
    public void reSpawnNpc() {
        ...
        if (canReSpawn()) {
        	...
        	Gdx.app.debug("Debug: ", "{{{{{{{ DEBUG }}}}}}} NO PUEDE RESPAWN !!!");
        }
    }
    ...
    public void quitarNPC() {
    	if (DEBUG) {
    		Gdx.app.debug("Debug: ", "NPC BORRADO");
    	}
        ...
        if (ownerNpc != null) {
        	if (ownerNpc.isTrainer()) {
        		...
        		Gdx.app.debug("Debug: ", "ERROR, el NPC propietario de la mascota no es un entrenador!!! npc_type=" + ownerNpc.npcType());
        	}
        }
        ...
        if (this.petUserOwner != null) {
            ...
            if (mapa.isLegalPos(newPos, false, true)) {
                ...
                if (mapa.getNPC(newPos.x, newPos.y) != null) {
                    Gdx.app.debug("Debug: ", "m_flags.AguaValida=" + isWaterValid());
                    Gdx.app.debug("Debug: ", "OJO, ya hay otro NPC!!! " + this + " " +
