package com.argentumjk.client.graphics;
...
import com.argentumjk.client.objects.GrhData;
...
public final class Drawer {
    ...
    public static void drawGrh(Batch batch, Grh grh, float x, float y, DrawParameter dp) {
        GrhData grhData = Game.getInstance().getAssets().getGrhs().getGrhData(grh.getIndex());
    ...
    public static void drawGrh(Batch batch, int index, float x, float y, DrawParameter dp) {
        GrhData grhDataCurrent = Game.getInstance().getAssets().getGrhs().getGrhData(index);
    ...
    public static TextureRegion getTextureRegion(int numGrafico, Rect r) {
        TextureRegion reg = Game.getInstance().getAssets().getTextures().getTextureRegion(numGrafico);
    ...
    public static Config getConfig() { return Game.getInstance().getConfig(); }
}
