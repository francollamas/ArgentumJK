...
import com.argentumjk.client.managers.screens.CrearPjManager;
...
public class CrearPjView extends View {
    ...
    private VisSelectBox<String> sbClase;
        ...
        tbCrearPj.addListener(new ClickListener() {
            ...
            public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
                ...
                getGestor().crearPj(tfNombre.getText().trim(), tfContraseña.getText(), tfRContraseña.getText(),
                        ...
                        sbRaza.getSelectedIndex() + 1, sbGenero.getSelectedIndex() + 1, sbClase.getSelectedIndex() + 1, sbCiudad.getSelectedIndex() + 1);
            }
        });

        setFocus(tfNombre);
        Game.getInstance().getMidiPlayer().play(7);
