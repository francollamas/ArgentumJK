...
import static com.argentumjk.server.util.Color.COLOR_CYAN;
import static com.argentumjk.server.util.FontType.FONTTYPE_FIGHT;
...
import com.argentumjk.server.AbstractCharacter;
import com.argentumjk.server.CharInfo;
import com.argentumjk.server.City;
import com.argentumjk.server.Clazz;
...
import com.argentumjk.server.Pos;
import com.argentumjk.server.Security;
import com.argentumjk.server.Skill;
import com.argentumjk.server.anticheat.SpeedHackCheck;
import com.argentumjk.server.anticheat.SpeedHackException;
import com.argentumjk.server.areas.AreasAO;
import com.argentumjk.server.guilds.Guild;
import com.argentumjk.server.guilds.GuildUser;
import com.argentumjk.server.inventory.BankInventory;
import com.argentumjk.server.inventory.InventoryObject;
import com.argentumjk.server.inventory.UserInventory;
import com.argentumjk.server.map.Heading;
import com.argentumjk.server.map.Map;
import com.argentumjk.server.map.MapObject;
import com.argentumjk.server.map.MapPos;
import com.argentumjk.server.map.Terrain;
import com.argentumjk.server.map.Tile.Trigger;
import com.argentumjk.server.map.Zone;
import com.argentumjk.server.net.ServerPacket;
import com.argentumjk.server.npc.Npc;
import com.argentumjk.server.npc.NpcCashier;
import com.argentumjk.server.npc.NpcGambler;
import com.argentumjk.server.npc.NpcTrainer;
import com.argentumjk.server.npc.NpcType;
import com.argentumjk.server.protocol.AttributesResponse;
import com.argentumjk.server.protocol.BlindNoMoreResponse;
import com.argentumjk.server.protocol.BlockPositionResponse;
import com.argentumjk.server.protocol.BlockedWithShieldOtherResponse;
import com.argentumjk.server.protocol.BlockedWithShieldUserResponse;
import com.argentumjk.server.protocol.ChangeInventorySlotResponse;
import com.argentumjk.server.protocol.ChangeMapResponse;
import com.argentumjk.server.protocol.CharacterChangeResponse;
import com.argentumjk.server.protocol.CharacterCreateResponse;
import com.argentumjk.server.protocol.ChatOverHeadResponse;
import com.argentumjk.server.protocol.ConsoleMsgResponse;
import com.argentumjk.server.protocol.DiceRollResponse;
import com.argentumjk.server.protocol.DisconnectResponse;
import com.argentumjk.server.protocol.DumbNoMoreResponse;
import com.argentumjk.server.protocol.DumbResponse;
import com.argentumjk.server.protocol.ErrorMsgResponse;
import com.argentumjk.server.protocol.LevelUpResponse;
import com.argentumjk.server.protocol.LoggedMessageResponse;
import com.argentumjk.server.protocol.MeditateToggleResponse;
import com.argentumjk.server.protocol.MiniStatsResponse;
import com.argentumjk.server.protocol.NPCHitUserResponse;
import com.argentumjk.server.protocol.NPCKillUserResponse;
import com.argentumjk.server.protocol.NavigateToggleResponse;
import com.argentumjk.server.protocol.ObjectCreateResponse;
import com.argentumjk.server.protocol.ParalizeOKResponse;
import com.argentumjk.server.protocol.PlayMidiResponse;
import com.argentumjk.server.protocol.PlayWaveResponse;
import com.argentumjk.server.protocol.PongResponse;
import com.argentumjk.server.protocol.PosUpdateResponse;
import com.argentumjk.server.protocol.RainToggleResponse;
import com.argentumjk.server.protocol.RemoveAllDialogsResponse;
import com.argentumjk.server.protocol.RemoveCharDialogResponse;
import com.argentumjk.server.protocol.RestOKResponse;
import com.argentumjk.server.protocol.ResuscitationSafeOffResponse;
import com.argentumjk.server.protocol.ResuscitationSafeOnResponse;
import com.argentumjk.server.protocol.SafeModeOffResponse;
import com.argentumjk.server.protocol.SafeModeOnResponse;
import com.argentumjk.server.protocol.SendSkillsResponse;
import com.argentumjk.server.protocol.SetInvisibleResponse;
import com.argentumjk.server.protocol.ShowBlacksmithFormResponse;
import com.argentumjk.server.protocol.UpdateHPResponse;
import com.argentumjk.server.protocol.UpdateHungerAndThirstResponse;
import com.argentumjk.server.protocol.UpdateTagAndStatusResponse;
import com.argentumjk.server.protocol.UpdateUserStatsResponse;
import com.argentumjk.server.protocol.UserAttackedSwingResponse;
import com.argentumjk.server.protocol.UserCharIndexInServerResponse;
import com.argentumjk.server.protocol.UserHitNPCResponse;
import com.argentumjk.server.protocol.UserHittedByUserResponse;
import com.argentumjk.server.protocol.UserHittedUserResponse;
import com.argentumjk.server.protocol.UserIndexInServerResponse;
import com.argentumjk.server.protocol.UserSwingResponse;
import com.argentumjk.server.protocol.WorkRequestTargetResponse;
import com.argentumjk.server.quest.UserQuest;
import com.argentumjk.server.user.UserAttributes.Attribute;
import com.argentumjk.server.util.Color;
