...
import static com.argentumjk.server.Constants.IntervaloParalizado;
import static com.argentumjk.server.Constants.NingunArma;
import static com.argentumjk.server.Constants.NingunCasco;
import static com.argentumjk.server.Constants.NingunEscudo;
import static com.argentumjk.server.Constants.OBJ_INDEX_CABEZA_MUERTO;
import static com.argentumjk.server.Constants.OBJ_INDEX_CUERPO_MUERTO;
...
import com.argentumjk.server.protocol.CharacterInfoResponse;
...
public class UserStorage {
	...
	throws IOException {
		...
		if (user.clazz == null) {
			throw new IOException("Clase desconocida: " + ini.getString("INIT", "Clase").toUpperCase());
		}
	...
	public static CharacterInfoResponse createCharacterInfoResponse(String userName) {
        ...
        End If
			...
			Gdx.app.error("Fatal: ", "ERROR getChrInfo", e);
		}
		return null;
	}
	...
	public void saveUserToStorage() {
		...
		try {
			...
			Gdx.app.error("Fatal: ", user.getUserName() + ": ERROR EN SAVEUSER()", e);
		}
	}
