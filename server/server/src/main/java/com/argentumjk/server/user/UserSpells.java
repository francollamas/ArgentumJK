...
import com.argentumjk.server.protocol.BlindResponse;
import com.argentumjk.server.protocol.ChangeSpellSlotResponse;
...
import com.argentumjk.server.protocol.UpdateManaResponse;
import com.argentumjk.server.protocol.UpdateStaResponse;
import com.argentumjk.server.user.User.DuelStatus;
...
public class UserSpells implements Constants {
	...
	public void castSpell(short slot) {
		...
		Gdx.app.log("Info: ", "castSpell =====> " + this.user.getFlags().Hechizo);
	}
