...
public class ServerPackages {
    ...
    private void handleConsoleMsg() throws NotEnoughDataException {
        getGD().getConsola().addMessage(r.readString(), FontTypeName.values()[r.readByte()]);
    ...
    public void handlePong() {
        ...
        getGD().getConsola().addMessage("El ping es de " + ping + " ms.", FontTypeName.Warning);
    }
    ...
    public void handleMultiMessage() throws NotEnoughDataException {
        ...
        Message msg = Message.values()[r.readByte()];
