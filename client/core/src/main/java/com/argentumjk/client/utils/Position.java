...
public class Position {
     ...
     */
    public static Position dirToPos(Direccion dir) {
    ...
    public static Direccion posToDir(Position pos) {
        ...
        if (pos.getX() == 1) dir = Direccion.ESTE;
        else if (pos.getX() == -1) dir = Direccion.OESTE;
        else if (pos.getY() == 1) dir = Direccion.SUR;
        else if (pos.getY() == -1) dir = Direccion.NORTE;
