...
;
import com.argentumjk.server.AbstractCharStats;
...
public class UserStats extends AbstractCharStats {
	...
	public void addGold(int amount) {
		...
		if (this.gold > MAX_GOLD) {
			Gdx.app.log("Warn: ", "Se superó el máximo de oro " + this.gold);
			this.gold = MAX_GOLD;
		}
		if (this.gold < 0) {
			Gdx.app.log("Warn: ", "Se superó el mínimo de oro " + this.gold);
			this.gold = 0;
		}
	}
