...
import com.argentumjk.server.protocol.ShowGMPanelFormResponse;
import com.argentumjk.server.protocol.ShowMessageBoxResponse;
import com.argentumjk.server.protocol.SpawnListResponse;
import com.argentumjk.server.protocol.UserNameListResponse;
import com.argentumjk.server.user.FactionArmors;
import com.argentumjk.server.user.User;
import com.argentumjk.server.user.UserAttributes.Attribute;
import com.argentumjk.server.user.UserFaction;
...
public class ManagerServer {
    ...
    public void loadAdminsSpawnableCreatures() {
        Gdx.app.log("Trace: ", "loading list of spawnable creatures");
        try {
    ...
    public void loadInvalidNamesList() {
        ...
        try {
            ...
            Gdx.app.log("Warn: ", "Error abriendo archivo de nombres inválidos");
            e.printStackTrace();
        } catch (IOException e) {
            Gdx.app.log("Warn: ", "Error leyendo archivo de nombres inválidos");
            e.printStackTrace();
        }
    }

    public void loadAdmins() {
        Gdx.app.log("Trace: ", "loading admins");
        try {
            ...
            // Cargar dioses:
            IniFile ini = new IniFile(Constants.DAT_DIR + File.separator + "Server.ini");
            ...
            Gdx.app.log("Warn: ", "Admins loaded");
        } catch (java.io.FileNotFoundException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void sendSpawnCreatureList(User admin) {
        ...
        admin.sendPacket(new SpawnListResponse(Util.join("\0", Arrays.asList(getSpawnListNames()))));
    }
    ...
    public void sendUserNameList(User admin) {
        ...
        String userNamesList = Util.join("" + Constants.NULL_CHAR, this.server.getUsuariosConectados());
    ...
    public void shutdownServer(User admin) {
        ...
        Gdx.app.log("Info: ", "SERVIDOR APAGADO POR " + admin.getUserName());
    ...
    public void showGmOnline(User admin) {
        ...
        if (gmsOnline.size() > 0) {
            String gmsList = Util.join("" + Constants.NULL_CHAR, gmsOnline);
    ...
    public void lastIp(User admin, String userName) {
        ...
        admin.sendMessage("Últimas IP de " + userName + " son: " + Util.join(", ", ipList),
                FontType.FONTTYPE_INFO);
    }
    ...
    public void bugReport(User user, String bugReport) {
        ...
        sb.append("Usuario:")
                ...
                .append(bugReport)
                .append("\n########################################################################\n");
        fileHandle.writeString(sb.toString(), true);
