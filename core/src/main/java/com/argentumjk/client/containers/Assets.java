...
import com.argentumjk.client.objects.Map;

import static com.argentumjk.client.containers.PartChar.*;
...
public class Assets {
    ...
    public Assets() {
        ...
        gdxAssets.load(getTextureAtlasDir(), TextureAtlas.class);
        gdxAssets.finishLoading();
        textureAtlas = gdxAssets.get(getTextureAtlasDir(), TextureAtlas.class);
    }

    public AssetManager getGDXAssets() {
        return gdxAssets;
    }
    ...
    public PartChar getHeads() {
        return heads;
    }

    public PartChar getHelmets() {
        return helmets;
    }

    public PartChar getWeapons() {
        return weapons;
    }

    public PartChar getShields() {
        return shields;
    }
