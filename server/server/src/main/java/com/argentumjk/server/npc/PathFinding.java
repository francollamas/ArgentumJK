...
import com.argentumjk.server.aStar.AStar;
import com.argentumjk.server.aStar.Constants;
import com.argentumjk.server.aStar.Location;
import com.argentumjk.server.aStar.Node;
...
public class PathFinding {
    ...
    private void followPath() {
        this.current_step++;
        com.argentumjk.server.aStar.Node node = this.current_path.get(this.current_step);
        com.argentumjk.server.aStar.Location loc = node.location;
