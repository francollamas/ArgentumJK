...
import com.argentumjk.server.protocol.ShowCarpenterFormResponse;
...
import com.argentumjk.server.user.UserGender;
...
public class UserInventory extends Inventory implements Constants {
    ...
    public void useInvItem(short slot) {
        ...
        switch (infoObjInv.objType) {
            ...
            default:
                Gdx.app.error("Fatal: ", "No se como usar este tipo de objeto: " + infoObjInv.objType);
        }
    }
