...
import com.argentumjk.server.gm.ChangeMapInfo;
import com.argentumjk.server.gm.EditChar;
...
class ProcessingHandler extends ChannelInboundHandlerAdapter {
	...
	public void channelRead(ChannelHandlerContext ctx, Object packet) throws Exception {
		...
		// TODO
		Gson gson = new Gson();
		Gdx.app.debug("Debug: ", "processing handler " + packet.getClass().getCanonicalName());
