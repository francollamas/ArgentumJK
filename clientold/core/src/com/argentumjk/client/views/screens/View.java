...
import com.argentumjk.client.managers.screens.ViewManager;

import static com.argentumjk.client.general.FileNames.getGuiDir;
...
public abstract class View implements Screen {
    ...
    public void setScreen(Screen scr) { Game.getInstance().setScreen(scr); }
